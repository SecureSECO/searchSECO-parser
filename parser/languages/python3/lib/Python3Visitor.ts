...
export interface Python3Visitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.funcbody`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.expr_stmt_single`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitExpr_stmt_single?: (ctx: Expr_stmt_singleContext) => Result;

	/**
	 * Visit a parse tree produced by `Python3Parser.expr_stmt_multi`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitExpr_stmt_multi?: (ctx: Expr_stmt_multiContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.string`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.funccallname`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitFunccallname?: (ctx: FunccallnameContext) => Result;
